...
public class ItemDefinition {
    ...
    public static final Item WET_MEET = ItemRegistration.Register(new Item(new Item.Settings().food(new FoodComponent.Builder().statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, MinersLife.tickFrom(10)), 1).statusEffect(new StatusEffectInstance(StatusEffects.POISON, MinersLife.tickFrom(10)), 1).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, MinersLife.tickFrom(10)), 1).build())), "wet_meet");
